export const CATS = [
  ["CAT.01", "Catering", "Food service, bar packages, staffed or drop-off, dietary options."],
  ["CAT.02", "Venues", "Halls, warehouses, gyms, fields and outdoor sites with capacity notes."],
  ["CAT.03", "Décor", "Florals, styling, table settings, backdrops and thematic decor."],
  ["CAT.04", "Rentals", "Tables, chairs, linens, tents, lounge sets, delivery and pickup."],
  ["CAT.05", "Staging", "Stages, risers, platforms, trussing and structural builds."],
  ["CAT.06", "Production", "Sound, screens, projection and an operator on site."],
  ["CAT.07", "Lighting", "Uplighting, stage wash, string lights and architectural lighting design."],
  ["CAT.08", "Photography", "Event coverage, headshot booths, same-day edits and video."],
  ["CAT.09", "Entertainment", "DJs, bands, live performers, MCs, hosts and speakers."],
  ["CAT.10", "Planning", "Full and partial event planning, coordination, staffing and day-of management."],
  ["CAT.11", "Printing & Signage", "Banners, wayfinding, badges, table cards, floor decals."],
  ["CAT.12", "Merchandise", "Shirts, bags, bottles, lanyards and giveaway items."],
  ["CAT.13", "Logistics", "Equipment delivery and pickup, transportation, courier and storage."],
  ["CAT.14", "Security & Safety", "Event security staff, crowd management, first aid and safety planning."],
];

export const PLANNING_REQUIREMENTS = ["Permits", "Insurance", "Registration", "Approvals", "Timelines"];

export const EVENTS = [
  ["Team building day", ["CAT.01", "CAT.02", "CAT.09", "CAT.13"], "Staff and internal", 1],
  ["Christmas party", ["CAT.01", "CAT.02", "CAT.04", "CAT.08", "CAT.09"], "Staff and internal", 1],
  ["Company fete", ["CAT.01", "CAT.02", "CAT.06", "CAT.09", "CAT.10"], "Staff and internal", 0],
  ["Award ceremony", ["CAT.01", "CAT.02", "CAT.06", "CAT.08", "CAT.09"], "Staff and internal", 0],
  ["Staff training day", ["CAT.01", "CAT.02", "CAT.06", "CAT.11"], "Staff and internal", 0],
  ["Team hackathon", ["CAT.01", "CAT.02", "CAT.06", "CAT.12"], "Staff and internal", 0],
  ["Product launch", ["CAT.01", "CAT.02", "CAT.06", "CAT.08", "CAT.09", "CAT.11", "CAT.12"], "Customer facing", 1],
  ["Networking mixer", ["CAT.01", "CAT.02", "CAT.04", "CAT.08", "CAT.10"], "Customer facing", 1],
  ["Trade show booth", ["CAT.04", "CAT.06", "CAT.10", "CAT.11", "CAT.12"], "Customer facing", 1],
  ["Conference", ["CAT.01", "CAT.02", "CAT.06", "CAT.08", "CAT.10", "CAT.11"], "Customer facing", 0],
  ["Open house", ["CAT.01", "CAT.04", "CAT.09", "CAT.11"], "Customer facing", 0],
  ["Client appreciation dinner", ["CAT.01", "CAT.02", "CAT.04", "CAT.08"], "Customer facing", 0],
  ["Church harvest or fundraiser", ["CAT.01", "CAT.04", "CAT.10", "CAT.11"], "Community and fundraising", 1],
  ["5K or charity run", ["CAT.04", "CAT.10", "CAT.11", "CAT.12", "CAT.13"], "Community and fundraising", 1],
  ["School fair", ["CAT.01", "CAT.04", "CAT.09", "CAT.11"], "Community and fundraising", 0],
  ["Graduation", ["CAT.01", "CAT.02", "CAT.06", "CAT.08", "CAT.11"], "Community and fundraising", 0],
  ["Community meeting", ["CAT.02", "CAT.04", "CAT.06", "CAT.10"], "Community and fundraising", 0],
];
...
export const SUPPLIERS = [
  ...
  { id: "s5", code: "CAT.06", name: "Sound Base AV", city: "Port of Spain", region: "Port of Spain", desc: "Two-person crews for talks, panels and awards nights. Everything comes with an operator, so nobody on your team runs the board.",
  ...
  { id: "s7", code: "CAT.08", name: "Northside Film and Photo", city: "Port of Spain", region: "Port of Spain", desc: "Documentary event coverage and a fast headshot setup. Galleries land within three days, licensed for internal and marketing use.",
  ...
  { id: "s8", code: "CAT.11", name: "Ridgeway Print and Signs", city: "Arima", region: "Arima", desc: "Signage shop that handles wayfinding for runs and expos. Sends a proof within a day and will hold files for reprints next year.",
  ...
  { id: "s9", code: "CAT.10", name: "Crossroads Event Staffing", city: "San Fernando", region: "San Fernando", desc: "Registration, ushers and setup crews booked by the shift. Staff arrive briefed, in plain black, with a lead on site for groups over six.",
  ...
  { id: "s10", code: "CAT.09", name: "Sundown Sound", city: "Scarborough, Tobago", region: "Tobago", desc: "DJs and hosts who read a corporate room. Brings its own small PA, so you can skip a separate AV order for parties under 150.",
