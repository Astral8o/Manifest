...
(function () {
  ...
  var STEPS = [
    ...
    ['No-cost vs Spotlight', 'Every listing gets unlimited inquiries at no cost. Spotlight (TTD $175/month) adds visibility: featured placement, email marketing, social media and Magazine features.', 'Show the plans', function () { signIn('vendor@demo.tt', '/inbox/'); setTimeout(function () { var el = document.getElementById('spotlight-tiers'); if (el) el.scrollIntoView(); }, 900); }],
