...
(function () {
  ...
  var STEPS = [
    ...
    ['No-cost vs Spotlight', 'The no-cost listing includes 4 inquiries. After that they’re saved but held. Spotlight (TTD $175/month) opens them and adds visibility.', 'Show the plans', function () { signIn('vendor@demo.tt', '/inbox/'); setTimeout(function () { var el = document.getElementById('spotlight-tiers'); if (el) el.scrollIntoView(); }, 900); }],
